...
export const OFFRES_PAGES: OffreDetail[] = [
  ...
  },
  {
    ...
    reperes: [
      ...
      { valeur: '24 points', libelle: 'De contrôle, listés sur cette page' },
    ],
    ...
    livrables: [
      ...
      {
        titre: 'Les 24 points vérifiés',
        resume: 'La liste est publique : vous savez exactement ce que vous achetez.',
        points: [
          'Réconciliation des ventes réelles avec GA4, Meta et Google Ads',
          'Écart chiffré par canal, et part imputable à la mesure',
          'Conteneur GTM : balises actives, déclencheurs, variables orphelines',
          'Événements e-commerce testés sur un achat réel',
          'Formulaires et prises de rendez-vous testés en conditions réelles',
          'Cas multi-pays et multi-conteneurs',
          'Formulaires envoyés en AJAX, non détectés par les déclencheurs natifs',
          'Paiement hébergé et retour de la page de confirmation',
          'Déduplication pixel et API côté Meta',
          'Qualité de correspondance des événements Meta',
          'Enhanced Conversions : présentes, absentes ou mal configurées',
          'Conversions offline et rattachement au clic, si CRM',
          'Actions de conversion Google Ads : ce qui sert à enchérir',
          'Doublons entre GA4 et Google Ads',
          'Consent Mode v2 : présent, câblé, ou déclaré sans effet',
          'Balises qui se déclenchent malgré un refus',
          'Bandeau de consentement et outils en doublon',
          'Dimensions personnalisées et événements clés déclarés dans GA4',
          'Conservation des données et filtre de trafic interne',
          'Exclusions de référence et paramètres de campagne perdus en redirection',
          'Export BigQuery : actif ou non',
          'Temps de chargement des balises sur mobile',
          'Cohérence des noms d’événements avec une convention lisible',
          'Documentation existante, et ce qu’il en reste',
        ],
      },
      {
